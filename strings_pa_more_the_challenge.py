...
>> Hi Nicole I. Tibay! You have successfully redeem 
reward #1 - Coke sakto! Thank you for choosing Aling Nena’s 
Sari-sari store.
"""
...
print(f"Hi {name}! You have successfully redeem"
      + f"reward #{choice} - {rewards[int(choice)]}!" 
